# Salt Extension for Proxmox V9X

Salt Extension for Salt Cloud using Proxmox VE v9.x
...
The saltext-proxmox-v9x project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:bbruun/saltext-proxmox-v9x.git

# Change to the repo dir
cd saltext-proxmox-v9x
```
...
* Writing blog posts
* Sharing your experiences using Salt + Proxmox V9X
  on social media
...
[issues]: https://github.com/bbruun/saltext-proxmox-v9x/issues
[PRs]: https://github.com/bbruun/saltext-proxmox-v9x/pulls
[discussions]: https://github.com/bbruun/saltext-proxmox-v9x/discussions
